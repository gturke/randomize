...
class Randomize(object):
    ...
    def __init__(self, strata,
        ...
        # AMS: User enters a list of strata numbers.
    ...
    def genTreatCounts(self, n, treat_distrib):
        # AMS: How/When does n get defined?
        ...
        # AMS: What are the brackets around these numbers?
    ...
    def strat_rand(self):
        ...
        # AMS: set() has no effect on data
        for i in set(self.strata):
            # AMS: n = sum of the true values where the loop variable, i and thevalues in the strata are equal and therefore True.
            # AMS: ends up returns values user entered and assigning them to assign_count 
